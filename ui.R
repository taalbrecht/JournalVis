...
shinyUI(fluidPage(
  ...
  column(9,navbarPage("Graphical Analysis",
                      ...
                      tabPanel("Topic Map",
                               tags$div(title = "Full document text matching takes an entire sentence, paragraph, or document as input and tries to find the closest match based on the overall topic content of the search query. Cut and paste is supported.", h4("Full Document Text Matching")),
